-- Generated by snipgen 1 from highlightlatex.cwl; do not edit, regenerate.
-- source: TeXstudio completion/highlightlatex.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 9fa8d86c2af1c97ddffa65b381d47a058cf4769783c4298a54f8045df4ee4dee
-- cwl-header:
--   # highlightlatex package
...
return {
  package = "highlightlatex",
  includes = { "listings", "xcolor", "etoolbox" },
  lists = {},
  snippets = {
    S({ trig = "\\highlightblock", dscr = "\\begin{highlightblock}" }, { t({ "\\begin{highlightblock}", "\t" }), i(1), t({ "", "\\end{highlightblock}" }) }, "V"),
    S({ trig = "\\highlightblock", dscr = "\\begin{highlightblock}[options]" }, { t("\\begin{highlightblock}["), i(1, "options"), t({ "]", "\t" }), i(2), t({ "", "\\end{highlightblock}" }) }, "V"),
    S({ trig = "\\defaultgobble", dscr = "∗", priority = 900 }, { t("\\defaultgobble") }, "*"),
    S({ trig = "\\updatehighlight", dscr = "{highlight rules}" }, { t("\\updatehighlight{"), i(1, "highlight rules"), t("}") }),
    S({ trig = "\\saveblock", dscr = "\\begin{saveblock}{name}" }, { t("\\begin{saveblock}{"), i(1, "name"), t({ "}", "\t" }), i(2), t({ "", "\\end{saveblock}" }) }),
    S({ trig = "\\useblock", dscr = "{name}" }, { t("\\useblock{"), i(1, "name"), t("}") }),
    S({ trig = "\\consumeblock", dscr = "{name}" }, { t("\\consumeblock{"), i(1, "name"), t("}") }),
  },
  keyvals = {
    {
      targets = "\\begin{highlightblock}",
      lines = {
        "inputpath=%<path%>",
        "aboveskip=##L",
        "belowskip=##L",
