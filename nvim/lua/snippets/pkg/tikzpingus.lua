-- Generated by snipgen 1 from tikzpingus.cwl; do not edit, regenerate.
-- source: TeXstudio completion/tikzpingus.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 8fc6ed36dc9a7399398c2bf66a3748dd1c0ae5ca08c86731097f7d8265f058e1
-- cwl-header:
--   # tikzpingus package
...
return {
  package = "tikzpingus",
  includes = { "etoolbox", "tikz", "tikzlibraryintersections", "tikzlibraryshadings", "tikzlibrarypatterns.meta", "tikzlibrarydecorations.pathmorphing", "tikzlibraryshapes.symbols", "tikzlibraryshapes.geometric" },
  lists = {},
  snippets = {
    S({ trig = "\\pingu", dscr = "" }, { t("\\pingu") }),
    S({ trig = "\\pingu", dscr = "[options]" }, { t("\\pingu["), i(1, "options"), t("]") }),
    S({ trig = "\\pingudefaults", dscr = "{options}" }, { t("\\pingudefaults{"), i(1, "options"), t("}") }),
    S({ trig = "\\pingudefaultsappend", dscr = "{options}" }, { t("\\pingudefaultsappend{"), i(1, "options"), t("}") }),
  },
  keyvals = {
    {
      targets = "\\usepackage/tikzpingus#c",
      lines = {
        "glows",
        "manual-layers",
      },
    ...
    {
      targets = "\\pingu#c,\\pingudefaults#c,\\pingudefaultsappend#c",
      lines = {
