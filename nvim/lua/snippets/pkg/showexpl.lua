-- Generated by snipgen 1 from showexpl.cwl; do not edit, regenerate.
-- source: TeXstudio completion/showexpl.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 1b9821cbc37a987b994b4afe4f9bb8082a814340e730ca650fc658d81fc46a17
-- cwl-header:
--   # showexpl package
...
return {
  package = "showexpl",
  includes = { "refcount", "listings", "graphicx", "varwidth", "float" },
  lists = {},
  snippets = {
    S({ trig = "\\LTXinputExample", dscr = "{file}" }, { t("\\LTXinputExample{"), i(1, "file"), t("}") }, "i"),
    S({ trig = "\\LTXinputExample", dscr = "[options]{file}" }, { t("\\LTXinputExample["), i(1, "options"), t("]{"), i(2, "file"), t("}") }, "i"),
    S({ trig = "\\LTXexample", dscr = "\\begin{LTXexample}" }, { t({ "\\begin{LTXexample}", "\t" }), i(1), t({ "", "\\end{LTXexample}" }) }),
    S({ trig = "\\LTXexample", dscr = "\\begin{LTXexample}[options]" }, { t("\\begin{LTXexample}["), i(1, "options"), t({ "]", "\t" }), i(2), t({ "", "\\end{LTXexample}" }) }),
    S({ trig = "\\ResultBox", dscr = "∗", priority = 900 }, { t("\\ResultBox") }, "*"),
    S({ trig = "\\ResultBoxSep", dscr = "∗", priority = 900 }, { t("\\ResultBoxSep") }, "*"),
    S({ trig = "\\ResultBoxRule", dscr = "∗", priority = 900 }, { t("\\ResultBoxRule") }, "*"),
    S({ trig = "\\theltxexample", dscr = "∗", priority = 900 }, { t("\\theltxexample") }, "*"),
  ...
  keyvals = {
    ...
    {
      targets = "\\lstset,\\lstdefinelanguage,\\lstdefinestyle,\\LTXinputExample,\\begin{LTXexample}",
      lines = {
