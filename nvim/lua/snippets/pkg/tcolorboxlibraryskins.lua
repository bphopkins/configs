-- Generated by snipgen 1 from tcolorboxlibraryskins.cwl; do not edit, regenerate.
-- source: TeXstudio completion/tcolorboxlibraryskins.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: e131d9ee803c1530e7c3c30f05f44949e2a8cdfc682d07ecf2abe80188cf49fd
-- cwl-header:
...
return {
  package = "tcolorboxlibraryskins",
  includes = { "tikzfill.image" },
  lists = {},
  snippets = {
    S({ trig = "\\tcboxedtitlewidth", dscr = "" }, { t("\\tcboxedtitlewidth") }, "L"),
    S({ trig = "\\tcboxedtitleheight", dscr = "" }, { t("\\tcboxedtitleheight") }, "L"),
    S({ trig = "\\tcbclipframe", dscr = "\\begin{tcbclipframe}" }, { t({ "\\begin{tcbclipframe}", "\t" }), i(1), t({ "", "\\end{tcbclipframe}" }) }),
    S({ trig = "\\tcbinvclipframe", dscr = "\\begin{tcbinvclipframe}" }, { t({ "\\begin{tcbinvclipframe}", "\t" }), i(1), t({ "", "\\end{tcbinvclipframe}" }) }),
    S({ trig = "\\tcbclipinterior", dscr = "\\begin{tcbclipinterior}" }, { t({ "\\begin{tcbclipinterior}", "\t" }), i(1), t({ "", "\\end{tcbclipinterior}" }) }),
    S({ trig = "\\tcbcliptitle", dscr = "\\begin{tcbcliptitle}" }, { t({ "\\begin{tcbcliptitle}", "\t" }), i(1), t({ "", "\\end{tcbcliptitle}" }) }),
    S({ trig = "\\tcbstartdraftmode", dscr = "∗", priority = 900 }, { t("\\tcbstartdraftmode") }, "*"),
    S({ trig = "\\tcbstopdraftmode", dscr = "∗", priority = 900 }, { t("\\tcbstopdraftmode") }, "*"),
    S({ trig = "\\tcbinterruptdraftmode", dscr = "∗", priority = 900 }, { t("\\tcbinterruptdraftmode") }, "*"),
    S({ trig = "\\tcbcontinuedraftmode", dscr = "∗", priority = 900 }, { t("\\tcbcontinuedraftmode") }, "*"),
    S({ trig = "\\tcbline", dscr = "" }, { t("\\tcbline") }),
    S({ trig = "\\tcbline*", dscr = "" }, { t("\\tcbline*") }),
    S({ trig = "\\tcboverlaplower", dscr = "" }, { t("\\tcboverlaplower") }, "L"),
    S({ trig = "\\tcbincludegraphics", dscr = "{imagefile}" }, { t("\\tcbincludegraphics{"), i(1, "imagefile"), t("}") }, "g"),
    S({ trig = "\\tcbincludegraphics", dscr = "[options]{imagefile}" }, { t("\\tcbincludegraphics["), i(1, "options"), t("]{"), i(2, "imagefile"), t("}") }, "g"),
    S({ trig = "\\imagename", dscr = "" }, { t("\\imagename") }),
    S({ trig = "\\tcbincludepdf", dscr = "{file}" }, { t("\\tcbincludepdf{"), i(1, "file"), t("}") }),
    S({ trig = "\\tcbincludepdf", dscr = "[options]{file}" }, { t("\\tcbincludepdf["), i(1, "options"), t("]{"), i(2, "file"), t("}") }),
    S({ trig = "\\imagepage", dscr = "" }, { t("\\imagepage") }),
    S({ trig = "\\pdfpages", dscr = "" }, { t("\\pdfpages") }),
    S({ trig = "\\tcbsettowidthofnode", dscr = "{register}{node}" }, { t("\\tcbsettowidthofnode{"), i(1, "register"), t("}{"), i(2, "node"), t("}") }),
    S({ trig = "\\tcbsetmacrotowidthofnode", dscr = "{macro}{node}" }, { t("\\tcbsetmacrotowidthofnode{"), i(1, "macro"), t("}{"), i(2, "node"), t("}") }, "d"),
    S({ trig = "\\tcbsettoheightofnode", dscr = "{register}{node}" }, { t("\\tcbsettoheightofnode{"), i(1, "register"), t("}{"), i(2, "node"), t("}") }),
    S({ trig = "\\tcbsetmacrotoheightofnode", dscr = "{macro}{node}" }, { t("\\tcbsetmacrotoheightofnode{"), i(1, "macro"), t("}{"), i(2, "node"), t("}") }, "d"),
    S({ trig = "\\tcbhypernode", dscr = "{macro}{node}" }, { t("\\tcbhypernode{"), i(1, "macro"), t("}{"), i(2, "node"), t("}") }),
  },
  keyvals = {
    {
    ...
    {
      targets = "\\tcbset,\\tcbincludegraphics,\\tcbincludepdf",
      lines = {
