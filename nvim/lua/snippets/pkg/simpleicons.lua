-- Generated by snipgen 1 from simpleicons.cwl; do not edit, regenerate.
-- source: TeXstudio completion/simpleicons.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 9ac67968670ae116e964235f44bf8832c68830fc790c6e0701f66338b250e7d6
-- cwl-header:
--   # simpleicons package
...
return {
  ...
  lists = {},
  snippets = {
    S({ trig = "\\simpleicon", dscr = "{name}" }, { t("\\simpleicon{"), i(1, "name"), t("}") }),
  },
  keyvals = {
    {
      targets = "\\simpleicon",
