-- Generated by snipgen 1 from tikz-dependency.cwl; do not edit, regenerate.
-- source: TeXstudio completion/tikz-dependency.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: acdb869b2e7906ee5c675f5bee57ce45d714853bd1a13b8d437a7c3b32115dab
-- cwl-header:
...
return {
  package = "tikz-dependency",
  includes = { "environ", "tikz", "tikzlibrarymatrix", "tikzlibrarybackgrounds", "tikzlibrarycalc", "tikzlibrarypatterns", "tikzlibrarypositioning", "tikzlibraryfit", "tikzlibraryshapes" },
  lists = {},
  snippets = {
    S({ trig = "\\dependency", dscr = "\\begin{dependency}" }, { t({ "\\begin{dependency}", "\t" }), i(1), t({ "", "\\end{dependency}" }) }, "\\pictureHighlight"),
    S({ trig = "\\dependency", dscr = "\\begin{dependency}[options]" }, { t("\\begin{dependency}["), i(1, "options"), t({ "]", "\t" }), i(2), t({ "", "\\end{dependency}" }) }),
    S({ trig = "\\deptext", dscr = "\\begin{deptext}" }, { t({ "\\begin{deptext}", "\t" }), i(1), t({ "", "\\end{deptext}" }) }),
    S({ trig = "\\deptext", dscr = "\\begin{deptext}[options]" }, { t("\\begin{deptext}["), i(1, "options"), t({ "]", "\t" }), i(2), t({ "", "\\end{deptext}" }) }),
    S({ trig = "\\depkeys", dscr = "{options}" }, { t("\\depkeys{"), i(1, "options"), t("}") }),
    S({ trig = "\\depedge", dscr = "{from-word}{to-word}{label}" }, { t("\\depedge{"), i(1, "from-word"), t("}{"), i(2, "to-word"), t("}{"), i(3, "label"), t("}") }),
    S({ trig = "\\depedge", dscr = "[options]{from-word}{to-word}{label}" }, { t("\\depedge["), i(1, "options"), t("]{"), i(2, "from-word"), t("}{"), i(3, "to-word"), t("}{"), i(4, "label"), t("}") }),
    S({ trig = "\\deproot", dscr = "{root-offset}{label}" }, { t("\\deproot{"), i(1, "root-offset"), t("}{"), i(2, "label"), t("}") }),
    S({ trig = "\\deproot", dscr = "[options]{root-offset}{label}" }, { t("\\deproot["), i(1, "options"), t("]{"), i(2, "root-offset"), t("}{"), i(3, "label"), t("}") }),
    S({ trig = "\\wordgroup", dscr = "{row-offset}{word-offset-beg}{word-offset-end}{gid}" }, { t("\\wordgroup{"), i(1, "row-offset"), t("}{"), i(2, "word-offset-beg"), t("}{"), i(3, "word-offset-end"), t("}{"), i(4, "gid"), t("}") }),
    S({ trig = "\\wordgroup", dscr = "[options]{row-offset}{word-offset-beg}{word-offset-end}{gid}" }, { t("\\wordgroup["), i(1, "options"), t("]{"), i(2, "row-offset"), t("}{"), i(3, "word-offset-beg"), t("}{"), i(4, "word-offset-end"), t("}{"), i(5, "gid"), t("}") }),
    S({ trig = "\\groupedge", dscr = "{from-gid}{to-gid}{label}{height}" }, { t("\\groupedge{"), i(1, "from-gid"), t("}{"), i(2, "to-gid"), t("}{"), i(3, "label"), t("}{"), i(4, "height"), t("}") }),
    S({ trig = "\\groupedge", dscr = "[options]{from-gid}{to-gid}{label}{height}" }, { t("\\groupedge["), i(1, "options"), t("]{"), i(2, "from-gid"), t("}{"), i(3, "to-gid"), t("}{"), i(4, "label"), t("}{"), i(5, "height"), t("}") }),
    S({ trig = "\\depstyle", dscr = "{style name}{options}" }, { t("\\depstyle{"), i(1, "style name"), t("}{"), i(2, "options"), t("}") }, "s#%depstyle"),
    S({ trig = "\\matrixref", dscr = "" }, { t("\\matrixref") }),
    S({ trig = "\\wordref", dscr = "{row-offset}{word-offset}" }, { t("\\wordref{"), i(1, "row-offset"), t("}{"), i(2, "word-offset"), t("}") }),
    S({ trig = "\\rootref", dscr = "" }, { t("\\rootref") }),
    S({ trig = "\\storelabelnode", dscr = "{macro}" }, { t("\\storelabelnode{"), i(1, "macro"), t("}") }, "d"),
    S({ trig = "\\storefirstcorner", dscr = "{macro}" }, { t("\\storefirstcorner{"), i(1, "macro"), t("}") }, "d"),
    S({ trig = "\\storesecondcorner", dscr = "{macro}" }, { t("\\storesecondcorner{"), i(1, "macro"), t("}") }, "d"),
  },
  keyvals = {
    {
      targets = "\\begin{dependency}#c,\\begin{deptext}#c",
      lines = {
        "x=%<<dimen> or <coord>%>",
        "y=%<<dimen> or <coord>%>",
        "z=%<<dimen> or <coord>%>",
    ...
    {
      targets = "\\begin{dependency}#c,\\begin{deptext}#c,\\depkeys#c,\\depedge#c,\\deproot#c,\\wordgroup#c,\\groupedge#c",
      lines = {
