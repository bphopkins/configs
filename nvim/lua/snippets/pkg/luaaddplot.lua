-- Generated by snipgen 1 from luaaddplot.cwl; do not edit, regenerate.
-- source: TeXstudio completion/luaaddplot.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 3ef59f46fa017c463734daa92ff2c52207695926817ee19e687568ae928b4ce9
-- cwl-header:
--   # luaaddplot package
--   # Matthew Bertucci 3/22/2022 for v1.0
...
return {
  ...
  lists = {},
  snippets = {
    S({ trig = "\\luaaddplot", dscr = "file \"filename\";" }, { t("\\luaaddplot file \""), i(1, "filename"), t("\";") }),
    S({ trig = "\\luaaddplot", dscr = "file \"filename\", λ-expression;" }, { t("\\luaaddplot file \""), i(1, "filename"), t("\", "), i(2, "λ-expression"), t(";") }),
    S({ trig = "\\luaaddplot", dscr = "[options] file \"filename\";" }, { t("\\luaaddplot["), i(1, "options"), t("] file \""), i(2, "filename"), t("\";") }),
    S({ trig = "\\luaaddplot", dscr = "[options] file \"filename\", λ-expression;" }, { t("\\luaaddplot["), i(1, "options"), t("] file \""), i(2, "filename"), t("\", "), i(3, "λ-expression"), t(";") }),
  },
  keyvals = {
    {
      targets = "\\luaaddplot#c",
      lines = {
