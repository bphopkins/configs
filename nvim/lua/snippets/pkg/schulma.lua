-- Generated by snipgen 1 from schulma.cwl; do not edit, regenerate.
-- source: TeXstudio completion/schulma.cwl at commit 0362907c21d1f725288bb553c5360d1179b78c1b (2026-09-12)
-- cwl-sha256: 06450c143be4c54a93c5f7a7c2b107662de9a899cafbf874ab73f68a768552b1
-- cwl-header:
--   # schulma package
...
return {
  package = "schulma",
  includes = { "mathtools", "autoaligne", "icomma", "pgfplots", "tikzlibraryshapes.misc" },
  lists = {},
  snippets = {
    S({ trig = "\\Kosy", dscr = "\\begin{Kosy}" }, { t({ "\\begin{Kosy}", "\t" }), i(1), t({ "", "\\end{Kosy}" }) }, "\\pictureHighlight"),
    S({ trig = "\\Kosy", dscr = "\\begin{Kosy}[pgfplots options]" }, { t("\\begin{Kosy}["), i(1, "pgfplots options"), t({ "]", "\t" }), i(2), t({ "", "\\end{Kosy}" }) }),
    S({ trig = "\\LGS", dscr = "{Gleichungen}" }, { t("\\LGS{"), i(1, "Gleichungen"), t("}") }),
    S({ trig = "\\ehoch", dscr = "{Exponent}" }, h.mathwrap({ t("\\ehoch{"), i(1, "Exponent"), t("}") }), "m"),
    S({ trig = "\\diff", dscr = "{Variable}" }, h.mathwrap({ t("\\diff{"), i(1, "Variable"), t("}") }), "m"),
    S({ trig = "\\Pkt", dscr = "{x}{y}" }, { t("\\Pkt{"), i(1, "x"), t("}{"), i(2, "y"), t("}") }),
    S({ trig = "\\Pkt", dscr = "[Name]{x}{y}" }, { t("\\Pkt["), i(1, "Name"), t("]{"), i(2, "x"), t("}{"), i(3, "y"), t("}") }),
    S({ trig = "\\PktR", dscr = "{x}{y}{z}" }, { t("\\PktR{"), i(1, "x"), t("}{"), i(2, "y"), t("}{"), i(3, "z"), t("}") }),
    S({ trig = "\\Pkt", dscr = "[Name]{x}{y}{z}" }, { t("\\Pkt["), i(1, "Name"), t("]{"), i(2, "x"), t("}{"), i(3, "y"), t("}{"), i(4, "z"), t("}") }),
    S({ trig = "\\Vek", dscr = "{x}{y}{z}" }, { t("\\Vek{"), i(1, "x"), t("}{"), i(2, "y"), t("}{"), i(3, "z"), t("}") }),
    S({ trig = "\\VekBr", dscr = "{x}{y}{z}" }, { t("\\VekBr{"), i(1, "x"), t("}{"), i(2, "y"), t("}{"), i(3, "z"), t("}") }),
    S({ trig = "\\GTRY", dscr = "{index}" }, { t("\\GTRY{"), i(1, "index"), t("}") }),
    S({ trig = "\\GTRY", dscr = "{index}[term]" }, { t("\\GTRY{"), i(1, "index"), t("}["), i(2, "term"), t("]") }),
    S({ trig = "\\Rechenkaestchen", dscr = "{Breite}{Höhe}" }, { t("\\Rechenkaestchen{"), i(1, "Breite"), t("}{"), i(2, "Höhe"), t("}") }),
    S({ trig = "\\Rechenkaestchen", dscr = "[Kästchengröße]{Breite}{Höhe}" }, { t("\\Rechenkaestchen["), i(1, "Kästchengröße"), t("]{"), i(2, "Breite"), t("}{"), i(3, "Höhe"), t("}") }),
  },
  keyvals = {
    {
      targets = "\\usepackage/schulma#c",
      lines = {
        "ohne-icomma",
      },
    },
